...
import client.potlach.com.potlachandroid.widget.InfiniteScrollListView.LoadingMode;
import client.potlach.com.potlachandroid.widget.InfiniteScrollListView.StopPosition;
/**
...
public abstract class InfiniteScrollListAdapter extends BaseAdapter implements OnScrollListener {
	...
	public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
		if (view instanceof InfiniteScrollListView) {
			...
			if (loadingMode == InfiniteScrollListView.LoadingMode.SCROLL_TO_TOP && firstVisibleItem == 0 && canScroll) {
				onScrollNext();
			}

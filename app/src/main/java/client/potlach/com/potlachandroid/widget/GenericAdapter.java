package client.potlach.com.potlachandroid.widget;

/**
 * Created by thiago on 10/10/14.
 */
...
//        Log.d(GenericAdapter.class.getName(), "position: " + position+" datalist size: " + dataList.size());
    ...
    public View getFooterView(int position, View convertView,
                              ViewGroup parent) {
//        Log.d(GenericAdapter.class.getName(), "GetView Footer");
        ...
        if (row == null) {
            row = mActivity.getLayoutInflater().inflate(
                    R.layout.widget_gift_progress, parent, false);
            progressBar = (ProgressBar) row.findViewById(R.id.gift_load_progressBar);
        }
